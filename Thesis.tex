...
When trying to compare the security of individual wallet types, one of the important factors that determine its usability and security is wallet recovery rate. To compare hot and cold wallet approach using the chi-square test, following hypothesis was set:
\begin{itemize}\itemsep0em
\item H0: There is no difference between hot and cold wallet and their recovery rate.
\item H1: There is a difference between hot and cold wallet and their recovery rate.
\end{itemize}
