...
\begin{axis}[
    ...
    symbolic x coords={Windows, Linux, MacOS, Android, 
		iOS},
    xtick=data,
...
\rule{\linewidth}{1pt}%
\color{black}
\caption{Monero development timeline.}
\label{monero-timeline}
\end{figure}

In order to show automated installation process for both Windows and Linux miners, both installation processes were recorded using HDMI capture card and Open Broadcaster Software (OBS). Video is avaiable at \url{youtube.com} %TODO update link with video
